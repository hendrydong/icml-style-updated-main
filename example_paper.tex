...
\icmltitlerunning{Submission and Formatting Instructions}
...
\begin{itemize}
  ...
  \item Page limit: The main body of the paper has to be fitted to 8 pages,
        ...
        limited in pages. The submission PDF, including any appendices, may not
        exceed 50MB. For the final version of the paper, authors can add one
        extra page to the main body; the complete camera-ready PDF, including
        appendices, may not exceed 50MB.
...
single file and may not exceed 50MB. There is no separate camera-ready
...
requirements, and completing one does not replace the others. Uploaded release
or agreement PDFs should not exceed 50MB. Camera-ready authors may also be
